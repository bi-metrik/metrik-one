...
version: 2.1
updated: 2026-02-20
depends_on: [21], [98B], [98C], [98D], [98E], [99]
depended_by: [98F]
---
...
├─────────────────────────────────────────────────────────────┤
│ FRANJA CONCILIACIÓN                                         │
│ 💰 Caja: $4.200.000 ✅ Conciliado hoy  🔥 12 semanas      │
├─────────────────────────────────────────────────────────────┤
│ ┌──────────────────────┐ ┌──────────────────────┐          │
...
|-------|--------|-------------------|
| ≥ 80% | ✅ Datos confiables | → Evalúa Capa 2 (finanzas) |
| 50-79% | ⚠️ Datos parciales | → Semáforo amarillo de datos. Cards visibles con badge ⚠️ |
| < 50% | ❌ Datos insuficientes | → Semáforo rojo de datos. Cards OCULTAS |
...
│ ✅ Meta de ventas definida                                  │
│ ✅ Saldo bancario actualizado                               │

[5 CARDS VISIBLES con badge ⚠️ en cada una]
...
En TODOS los estados (incluso 🟢🟢) el checklist es expandible tocando "▼ Ver checklist". En verde muestra "✅ Todo al día" o sugerencias opcionales de mejora.
...
|-----------|--------|--------|
| ±$50.000 o ±2% (lo que sea mayor) | ✅ Cuadra | No muestra comparación |
| $50K-$500K o 2-10% | ⚠️ Diferencia menor | Muestra banco vs calculado |
...
```
│ 💰 Caja: $4.200.000 ⚠️ Hace 4 días  🔥 12 sem — ¡no pierdas tu racha! │
```
...
│ ⚠️ Diferencia: -$150.000  🔥 12 semanas                    │
```
...
**Flecha tendencia:** Compara con mismo día del mes anterior. ↑ mejoró, ↓ empeoró, = ±5%.
...
**Flecha tendencia:** vs mes anterior. **Invertida:** ↓ es verde (cartera bajó = bueno), ↑ es rojo.
...
**Flecha tendencia:** = si estable, ↑ si subió (costos aumentaron), ↓ si bajó.
...
─────────────────────────────────────────
✅ Arriendo oficina        $2.000.000  (pagado 5 feb)
✅ Internet                  $180.000  (pagado 8 feb)
...
✅ = confirmado/pagado (reconciliado con borrador — D84)
⬜ = pendiente
...
│                                                  │
│ 1️⃣ Configura tus gastos fijos mensuales          │
│    [Configurar →]                    ⬜ Pendiente │
│                                                  │
│ 2️⃣ Define tu meta de ventas del mes              │
│    [Definir →]                       ⬜ Pendiente │
│                                                  │
│ 3️⃣ Registra tu saldo bancario actual             │
│    [Registrar →]                     ⬜ Pendiente │
│                                                  │
│ 4️⃣ Crea tu primera oportunidad o proyecto        │
│    [Crear →]                         ⬜ Pendiente │
│                                                  │
...
├ 💰 Caja: $4.200.000 (conciliado hoy ✅)
├ 📈 Utilidad: +$5.200.000
├ 💵 Te deben: $6.300.000
├ 🎯 Ventas: $12.5M / $15M (83%)
└ 🏦 Aguantas: 4.2 meses

⚠️ 1 factura vencida de Pérez ($1.8M, 35 días)
...
En **Configuración** (tab ⚙️), sección "Mis Metas".
...
|---|---------|---------------|
| D101 | 5 Preguntas ONE: P3 = "¿Cuánto me deben?" Retiro disponible se absorbe en P&L de P2 | Carmen + Felipe → Mauricio ✅ |
| D102 | "Cuánto debo" integrado en drill-down P4 (gastos fijos corridos + PE). Opción A | Mik → Mauricio ✅ |
| D103-v3 | Semáforo doble capa: Capa 1 completitud (gate) → Capa 2 finanzas. Un solo semáforo visual | Mesa completa → Mauricio ✅ |
| D104 | Pulso del Mes fusionado dentro de 5 cards. Cada card tiene barra de progreso | Consenso → Mauricio ✅ |
| D105 | Barras con color dinámico: progreso vs ritmo esperado para el día del mes | Sofía → Mauricio ✅ |
| D106 | Drill-downs con links de navegación (no formularios). Terminan en acción | Sofía → Mauricio ✅ |
| D107 | Estado vacío: onboarding 4 pasos. No cards vacías | Sofía → Mauricio ✅ |
| D108 | Rojo: cards ocultas. Amarillo: cards con badge ⚠️. Verde: sin restricción. Checklist siempre expandible | Mauricio directo ✅ |
| D109 | Conciliación bancaria: usuario reporta saldo real, sistema compara con teórico | Carmen + equipo → Mauricio ✅ |
| D110 | Una cuenta MVP. Recálculo continuo desde último saldo real. Diferencia solo alerta | Max + Carmen → Mauricio ✅ |
| D111 | Tolerancia: ±$50K o ±2% = cuadra. $50K-500K = menor. >$500K = importante | Carmen → Mauricio ✅ |
| D112-rev | Conciliación = franja compacta entre semáforo y cards. Solo visualización, nunca input | Sofía + Mauricio directo ✅ |
| D113 | Saldo no actualizado > 7 días baja score completitud del semáforo | Hana + Sofía → Mauricio ✅ |
| D114 | 3 canales actualización saldo: app (FAB), WhatsApp (W32), push (martes/viernes) | Hana → Mauricio ✅ |
| D115 | P1 y P5 usan saldo real banco, no teórico. Banco siempre gana | Carmen → Mauricio ✅ |
| D116 | Cards = SOLO LECTURA. Cero inputs. Todo registro vía FAB, módulos o WhatsApp | Mauricio directo ✅ |
| D117 | Streak conciliación tipo Duolingo. Semanal. 4🥉/12🥈/26🥇/52🏆. Irrecuperable | Santiago → Mauricio ✅ |
| D118 | FAB: 4 acciones (oportunidad, gasto, cobro, actualizar saldo) | Max → Mauricio ✅ |
...
|-------|-------------|----------------------|
| `config_metas` | tenant_id, mes, meta_ventas, meta_recaudo | ✅ Sí |
| `saldos_banco` | tenant_id, saldo_real, saldo_teorico, diferencia, fecha, registrado_via | ✅ Sí |
| `streaks` | tenant_id, tipo, semanas_actuales, semanas_record | ✅ Sí |
