-- costo_horas ahora se calcula por registro de hora individual,
-- usando el salary/horas_disponibles_mes del staff que la registró.
-- Esto elimina la dependencia de un único staff con es_principal = true.

-- 1. v_proyecto_rubros_comparativo
