-- Fix: restaurar fecha_entrega_estimada y avance_calculado que se perdieron
-- en la migración 20260330600000, y conservar los nuevos campos
-- (oportunidad_codigo, responsable_nombre, ultima_actividad).
