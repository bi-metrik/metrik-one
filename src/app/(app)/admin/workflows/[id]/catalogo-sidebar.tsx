...
const BLOQUES: BloqueCatalogo[] = [
  ...
  { nombre: 'Cobros',             tipo: 'BloqueCobros',             icono: '💰', categoria: 'editable', puede_gate: false, descripcion: 'Cartera: anticipos, saldos, pagos. Muestra cobros confirmados y programados pendientes.' },
  { nombre: 'Plan recurrente',    tipo: 'BloquePlanRecurrente',     icono: '🔁', categoria: 'editable', puede_gate: true,  descripcion: 'Suscripcion / financiacion: monto fijo + frecuencia + duracion. Genera cobros programados automaticamente.' },
