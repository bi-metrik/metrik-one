...
export default function CausacionClient({ items, counts, activeTab, mes }: Props) {
    ...
    <div className="mx-auto max-w-2xl space-y-4 px-4 py-6">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 dark:border-blue-800 dark:bg-blue-950/30">
        ...
        <p className="text-[11px] text-blue-800 dark:text-blue-300 leading-relaxed">
          La causacion la gestiona el dueno o admin. Pronto podras invitar a tu contador para que gestione este proceso directamente.
        </p>
      </div>
