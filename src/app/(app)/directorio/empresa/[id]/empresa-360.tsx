...
import { SECTORES_EMPRESA, TIPOS_PERSONA, REGIMENES_TRIBUTARIOS, TIPOS_DOCUMENTO } from '@/lib/catalogos/constants'
              ...
              return (
                ...
                >
                  <div className="min-w-0">
                    ...
                    {n.contactos && (
                      <p className="ml-5.5 text-xs text-muted-foreground">{(n.contactos as { nombre: string }).nombre}</p>
                    )}
                  </div>
