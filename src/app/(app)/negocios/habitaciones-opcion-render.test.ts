 ...
 *  3. Cada captura dice «Habitación N» o «Solo para restar», con su botón para cambiarlo.
...
describe('R8 · el bloque de habitaciones de COT-2026-0013', () => {
  it('Posada Enilda: cupos completos, tres habitaciones numeradas y el costo por habitación', () => {
    ...
    expect(html).toContain('Usar solo para restar')
  ...
  it('una captura fijada a mano como «solo para restar» lo dice, y ofrece volver al reparto', () => {
    ...
    expect(html).toContain('Que lo decida el reparto')
    expect(html).toContain('Usar como habitación')
