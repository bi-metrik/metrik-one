  ...
  return (
    <div className="space-y-1">
      ...
      <DrillDownLinks links={[
        ...
        { label: 'Ir a Negocios', href: '/negocios' },
      ]} />
    </div>
  )
}
...
function DrillP2({ data }: { data: NumerosData; monthType: string }) {
  ...
  return (
    <div className="space-y-1">
      ...
      {/* MC por linea (decision Carmen 2026-05-04). Sin linea = bucket de costos variables sin negocio asignado */}
  ...
  return (
    <div className="space-y-1">
      ...
      <DrillDownLinks links={[
        ...
        ...(data.ventasMes < data.puntoEquilibrio ? [{ label: 'Ir a Negocios', href: '/negocios' }] : []),
      ]} />
    </div>
  )
}
