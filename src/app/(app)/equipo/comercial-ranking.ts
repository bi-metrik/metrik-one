...
export type RankingMetrica = 'honorario_recaudado' | 'valor_aprobado' | 'negocios_abiertos'
...
export function computeRanking(resumen: ComercialResumenRow[]): RankingEquipo {
  ...
  // Orden de presentacion por defecto: honorario recaudado desc.
  filas.sort((a, b) => a.rank_honorario - b.rank_honorario)
