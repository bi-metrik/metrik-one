          ...
          return (
            ...
            >
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-tinta text-xs font-bold text-white">
                  {iniciales(f.agente)}
                </div>
              ...
              <div className="mt-4 flex items-center justify-end text-xs font-semibold text-acento">
                Ver su perfil
