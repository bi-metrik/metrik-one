// Endpoint POST /api/afi/generar/[negocio_id]
// Dispara el motor de generacion AFI Fase B.
// Requiere sesion owner del workspace afi.

import { NextRequest, NextResponse } from 'next/server'
import { getWorkspace } from '@/lib/actions/get-workspace'
import { disparararGeneracionAFI } from '@/lib/afi/generar-paquete'
...
export async function POST(
  ...
  const result = await disparararGeneracionAFI(negocio_id)
