  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#FFFFFF;border-radius:8px;border:1px solid #E5E7EB;">
        ...
        <tr><td style="padding:8px 28px 0 28px;font-size:14px;line-height:1.6;color:${PALETA.tinta};">
          ...
          <p style="margin:18px 0 0 0;">
            <a href="${deepLink}" style="display:inline-block;padding:11px 22px;background:${PALETA.acento};color:#FFFFFF;text-decoration:none;border-radius:6px;font-weight:600;font-size:14px;">Revisar y aprobar</a>
          </p>
        </td></tr>
        <tr><td style="padding:18px 28px 22px 28px;border-top:1px solid #E5E7EB;margin-top:18px;font-size:11px;color:${PALETA.tintaSuave};">
