 ...
 */
import { RETENCION_ANIOS, RETENCION_ANIOS_EN_LETRAS, RETENCION_FUNDAMENTO } from './retencion';
  ...
  return [
    ...
    },
    {
      ...
      parrafos: [
        ...
        `Conservación: el expediente se conserva ${RETENCION_ANIOS_EN_LETRAS} (${RETENCION_ANIOS}) años contados desde el fin del vínculo, por deber legal de conservación (${RETENCION_FUNDAMENTO}, al que remiten la Resolución 2328 de 2025 de la Superintendencia de Transporte y la Circular Externa 100-000016 de 2020 de la Superintendencia de Sociedades). Durante ese plazo no se puede borrar, ni siquiera a petición tuya.`,
