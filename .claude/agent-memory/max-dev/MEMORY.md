...
- ⚠️⚠️ [Referencia `one://` para ve-documentos y gastos-soportes](project_referencia_archivos_one.md) — #748 mergeado (Paso A); `notificar-etapa` SIN redesplegar: el `{link}` al cliente sale crudo
