...
- ⚠️⚠️ [Referencia `one://` para ve-documentos y gastos-soportes](project_referencia_archivos_one.md) — Paso B YA aplicado (#755); falta Paso C y `notificar-etapa` SIN redesplegar
