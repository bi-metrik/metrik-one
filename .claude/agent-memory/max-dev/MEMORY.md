...
- ⚠️⚠️ [Gate de carpeta local](project_gate_carpeta_local.md) — PR #691 sin mergear: migracion SIN aplicar, clave SIN encender; y el arnes DO + tabla temporal que no dispara los AFTER
