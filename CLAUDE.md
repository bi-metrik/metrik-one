...
**Sesion:** 2026-08-10 (`metrik-one--core` → **lo que nace nuevo deja de nacer concedido a `anon`**). PR **#243** mergeado. **Las 4 migraciones estan aplicadas en produccion** y verificadas sobre el estado real de la base, no sobre el "success" del comando.
