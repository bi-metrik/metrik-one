...
- **⚠️⚠️ Dos archivos de migracion con el MISMO numero de version no fallan: `db push` da el numero por aplicado y salta el archivo en silencio.** `20260902000010` estaba en dos archivos de la misma jornada. **Revisar `supabase_migrations.schema_migrations` ANTES de aplicar**, no despues. Y `apply_migration` del MCP registra la fila con **su propio timestamp**, no con el del nombre del archivo: hay que mirar el ledger despues y renombrar el archivo a la version que quedo, o el repo miente sobre si mismo. Hoy conviven en el repo otras dos versiones duplicadas (`20260902000004`, `20260902000006`) y cinco migraciones aplicadas por MCP que nunca quedaron como archivo (`20260826141500`, `20260826162802`, `20260826211947`, `20260831171338`, `20260901192404`). **Merece un check de CI que rechace versiones duplicadas**: es la unica de las dos fallas que no se ve.
